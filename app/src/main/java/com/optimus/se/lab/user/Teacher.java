...
public class Teacher extends User {
    ...
    public Teacher(String username, String password, TimeTableAdapter timeTableAdapter, ListView lv_timeTable) {
        super(username, password, 1, timeTableAdapter, lv_timeTable);
    }
